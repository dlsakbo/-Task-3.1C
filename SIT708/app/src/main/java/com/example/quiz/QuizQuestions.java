...
public class QuizQuestions extends AppCompatActivity {
    ...
    private void updateProgress(int index) {
        int totalQuestions = questionList.size(); // Update total questions based on actual list size
    ...
    private String getSelectedAnswer() {
        if (option1Button.getBackground().getConstantState() == getResources().getDrawable(R.color.selectedOption).getConstantState()) {
            return option1Button.getText().toString();
        } else if (option2Button.getBackground().getConstantState() == getResources().getDrawable(R.color.selectedOption).getConstantState()) {
            return option2Button.getText().toString();
        } else if (option3Button.getBackground().getConstantState() == getResources().getDrawable(R.color.selectedOption).getConstantState()) {
            return option3Button.getText().toString();
        } else if (option4Button.getBackground().getConstantState() == getResources().getDrawable(R.color.selectedOption).getConstantState()) {
